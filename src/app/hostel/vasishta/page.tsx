...
export default function VasishtaHostelPortal() {
  const { user } = useAuth();
  ...
  const HOSTEL_NAME = 'Vasishta Bhavanam';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <ModernHeader
        title="Vasishta Bhavanam Portal"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          {filteredRequests.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">No visit requests found for Vasishta Bhavanam</p>
            </div>
          )}
        </div>
      </div>
