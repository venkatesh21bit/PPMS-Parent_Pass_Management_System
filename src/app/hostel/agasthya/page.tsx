  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full mx-auto max-h-[95vh] sm:max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-4 py-2 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 order-3 sm:order-1"
          >
            Cancel
          </button>
          <button
            ...
            className="w-full sm:w-auto px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 flex items-center justify-center space-x-2 order-2"
          >
            <X className="w-4 h-4" />
            <span>Reject</span>
          </button>
          <button
            ...
            className="w-full sm:w-auto px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center justify-center space-x-2 order-1 sm:order-3"
          >
...
export default function AgasthyaHostelPortal() {
  const { user } = useAuth();
  ...
  const HOSTEL_NAME = 'Agasthya Bhavanam';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <ModernHeader
        title="Agasthya Bhavanam Portal"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          {filteredRequests.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">No visit requests found for Agasthya Bhavanam</p>
            </div>
          )}
        </div>
      </div>
